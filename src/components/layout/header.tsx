...
export default function Header() {
  return <div className="flex h-100px p-10 justify-center pb-[100px]">
    <div className="block w-full mx-8 md:flex md:justify-between">
      <Link className="table m-auto sm:m-0 sm:block" href="/">
        <Image className="flex justify-center" alt="Munamii cakery" src="/logo.png" width={100} height={100}></Image>
      </Link>
